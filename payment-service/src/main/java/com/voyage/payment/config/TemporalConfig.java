...
import com.voyage.payment.activity.PaymentActivitiesImpl;
...
public class TemporalConfig implements SmartLifecycle {
    ...
    @Value("${temporal.queue:PaymentQueue}")
    ...
    public TemporalConfig(PaymentActivitiesImpl paymentActivities) {
    ...
    public WorkerFactory workerFactory(WorkflowClient client) {
        ...
        logger.info("Registered PaymentActivities with task queue: {}", taskQueue);
        return factory;
    }
