package com.voyage.cruise.config;

import com.voyage.cruise.activity.CruiseActivitiesImpl;
...
public class TemporalConfig implements SmartLifecycle {
    ...
    @Value("${temporal.queue:CruiseQueue}")
    private String taskQueue;

    private final CruiseActivitiesImpl cruiseActivities;
    private WorkerFactory factory;
    private boolean running = false;

    public TemporalConfig(CruiseActivitiesImpl cruiseActivities) {
    ...
    public WorkerFactory workerFactory(WorkflowClient client) {
        ...
        worker.registerActivitiesImplementations(cruiseActivities);
        logger.info("Registered CruiseActivities with task queue: {}", taskQueue);
        return factory;
    }
